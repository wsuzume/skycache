...
# This source file includes the work that is distributed in the Apache License 2.0.
# https://www.apache.org/licenses/LICENSE-2.0

# The main changes involve translating from Golang to Python. Additionally, some derived functions have been added.
